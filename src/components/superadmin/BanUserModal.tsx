...
export function BanUserModal({ nama, onConfirm, onClose }: { nama: string; onConfirm: (reason: string) => void; onClose: () => void }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 w-full">
        <p>
          Akun <span className="font-bold text-text-darker">{nama}</span> akan diblokir secara permanen dari platform. Berbeda dari Suspend, tindakan ini adalah sanksi berat dan pencabutannya memerlukan otorisasi tambahan.
        </p>
