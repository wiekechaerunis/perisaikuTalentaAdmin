import svgPaths from "./svg-e1b3eyrn6z";
...
function Sidebar() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[32px] h-[1539px] items-start p-[24px] relative shrink-0 w-[260px]" data-name="Sidebar">
...
function Frame26() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0">
      ...
      <p className="[word-break:break-word] font-['DM_Sans:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#383b46] text-[28px] whitespace-nowrap">Buat Lowongan baru</p>
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0">
      ...
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#64748b] text-[14px] whitespace-nowrap">Buat Lowongan Baru</p>
    </div>
  );
}
    ...
    <div className="bg-white h-[40px] relative rounded-[12px] shrink-0 w-full" data-name="select">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['DM_Sans:Regular',sans-serif] leading-[16px] min-w-px not-italic relative text-[#c5c6c9] text-[12px]">Contoh: Senior Product Designer</p>
        </div>
      </div>
    </div>
  );
...
function FieldIndustri() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[64px] items-start relative shrink-0 w-full" data-name="field-industri">
    ...
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[12px] w-full" data-name="select">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['DM_Sans:Regular',sans-serif] leading-[16px] min-w-px not-italic relative text-[#c5c6c9] text-[12px]">Pilih kategori pekerjaan</p>
...
function Select2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[12px] w-full" data-name="select">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['DM_Sans:Regular',sans-serif] leading-[16px] min-w-px not-italic relative text-[#c5c6c9] text-[12px]">Pilih tipe pekerjaan</p>
          <div className="content-stretch flex items-start relative shrink-0 size-[16px]" data-name="icon-chevron">
            <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Icon">
              <div className="absolute inset-[13.89%_13.89%_13.62%_14.18%]" data-name="product-outline">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.3867 14.4981">
...
function Select3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[12px] w-full" data-name="select">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['DM_Sans:Regular',sans-serif] leading-[16px] min-w-px not-italic relative text-[#c5c6c9] text-[12px]">Pilih Kota Lokasi Lowongan</p>
          <div className="content-stretch flex items-start relative shrink-0 size-[16px]" data-name="icon-chevron">
            <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Icon">
              <div className="absolute inset-[13.89%_13.89%_13.62%_14.18%]" data-name="product-outline">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.3867 14.4981">
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Frame">
      <p className="[word-break:break-word] font-['DM_Sans:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#383b46] text-[14px] whitespace-nowrap">Mode Kerja</p>
      <Frame11 />
    </div>
  );
}
  ...
  return (
    <div className="min-h-[160px] relative shrink-0 w-full" data-name="Input Area">
      <div className="content-stretch flex flex-col items-start min-h-[inherit] p-[16px] relative size-full">
        <div className="[word-break:break-word] font-['Open_Sans:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#c5c6c9] text-[12px] w-full whitespace-pre-wrap">
          <p className="leading-[18px] mb-0">Jelaskan posisi ini secara detail...</p>
...
function AssertiveText1() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Assertive Text">
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Open_Sans:Regular',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[#777980] text-[10px] text-right">
        <p className="leading-[16px]">0 / 5000</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[12px] w-full" data-name="select">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="[word-break:break-word] content-stretch flex gap-[8px] items-center not-italic px-[12px] relative size-full text-[12px]">
          ...
          <p className="flex-[1_0_0] font-['DM_Sans:Regular',sans-serif] leading-[16px] min-w-px relative text-[#c5c6c9]">0</p>
          <p className="font-['Open_Sans:Medium',sans-serif] leading-[18px] relative shrink-0 text-[#4c4f59] text-right whitespace-nowrap">/ bulan</p>
        </div>
      </div>
    </div>
  );
...
function Frame17() {
  return (
    <div className="content-stretch flex gap-[20px] h-[76px] items-center relative shrink-0 w-full" data-name="Frame">
      <FieldIndustri4 />
      <Frame28 />
      <FieldIndustri5 />
    </div>
...
function Select6() {
  return (
    <div className="bg-white h-[40px] relative rounded-[12px] shrink-0 w-full" data-name="select">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['DM_Sans:Regular',sans-serif] leading-[16px] min-w-px not-italic relative text-[#4c4f59] text-[12px]">In App</p>
          <div className="content-stretch flex items-start relative shrink-0 size-[16px]" data-name="icon-chevron">
            <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Icon">
              <div className="absolute inset-[13.89%_13.89%_13.62%_14.18%]" data-name="product-outline">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.3867 14.4981">
...
function FieldMetodeLamaran() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[508px]" data-name="field-metode-lamaran">
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#4c4f59] text-[12px] whitespace-nowrap">Metode Lamaran</p>
      <Select6 />
    </div>
  );
}
...
function FieldSkillTags() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[508px]" data-name="field-skill-tags">
...
function Select7() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[12px] w-full" data-name="select">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['DM_Sans:Regular',sans-serif] leading-[16px] min-w-px not-italic relative text-[#c5c6c9] text-[12px]">DD/MM/YYYY</p>
          <div className="content-stretch flex items-start relative shrink-0 size-[16px]" data-name="icon-chevron">
            <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Icon">
              <div className="absolute inset-[13.89%_13.89%_13.62%_14.18%]" data-name="product-outline">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.3867 14.4981">
...
function FieldIndustri6() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[76px] items-start relative shrink-0 w-[508px]" data-name="field-industri">
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#4c4f59] text-[12px] w-full">Batas Tanggal Pelamaran</p>
      <Select7 />
    </div>
  );
}
...
function FieldIndustri7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] h-[76px] items-start min-w-px relative" data-name="field-industri">
      <p className="[word-break:break-word] font-['DM_Sans:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#4c4f59] text-[12px] w-full">Kuota Posisi</p>
      <Select8 />
    </div>
  );
}
