import svgPaths from "./svg-c4xoq717m1";
...
export default function SuccessToast() {
  return (
    <div className="bg-[#fafffb] content-stretch drop-shadow-[0px_8px_12px_rgba(0,0,0,0.08)] flex gap-[12px] items-center px-[16px] py-[12px] relative rounded-[12px] size-full" data-name="Success Toast">
      ...
      <Icon />
      <p className="[word-break:break-word] font-['DM_Sans:SemiBold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#6acd75] text-[14px] whitespace-nowrap">Lowongan berhasil disimpan sebagai draft</p>
      <Close />
    </div>
  );
}