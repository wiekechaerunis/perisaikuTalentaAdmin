import svgPaths from "./svg-t7bok8zxyc";
  ...
  return (
    <div className="content-stretch flex gap-[20px] items-center relative shrink-0">
      ...
      <div className="bg-white content-stretch flex gap-[10px] h-[40px] items-center justify-center px-[12px] py-[8px] relative rounded-[20px] shrink-0 w-[85px]" data-name="Button">
        ...
        <p className="[word-break:break-word] flex-[1_0_0] font-['DM_Sans:Bold',sans-serif] leading-[20px] min-w-px not-italic relative text-[#0052ff] text-[14px]" style={{ fontFeatureSettings: '"lnum", "tnum"' }}>
          Filter
        </p>
...
function Frame22() {
  return (
    <div className="absolute bg-white content-stretch drop-shadow-[0px_1px_2px_rgba(0,0,0,0.16)] flex gap-[20px] h-[40px] items-center left-[906px] px-[10px] text-center top-0 w-[162px]">
...
function Frame8() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      <div className="[word-break:break-word] content-stretch flex font-['DM_Sans:Bold',sans-serif] gap-[20px] items-start leading-[16px] not-italic overflow-clip py-[12px] relative rounded-[inherit] size-full text-[#4c4f59] text-[12px]">
        <p className="relative shrink-0 w-[102px]">POSISI ID</p>
        <p className="relative shrink-0 w-[153px]">NAMA POSISI</p>
        <p className="relative shrink-0 w-[150px]">KATEGORI PEKERJAAN</p>
        <p className="relative shrink-0 w-[80px]">LOKASI</p>
        <p className="relative shrink-0 whitespace-nowrap">MODE KERJA</p>
        <p className="relative shrink-0 whitespace-nowrap">JUMLAH PELAMAR</p>
        <p className="relative shrink-0 whitespace-nowrap">KUOTA TERISI</p>
        <p className="relative shrink-0 whitespace-nowrap">TGL TUTUP</p>
        <p className="relative shrink-0 w-[103px]">TGL DIBUAT</p>
        <p className="relative shrink-0 whitespace-nowrap">DIBUAT OLEH</p>
        <Frame22 />
      </div>
...
function Frame23() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['DM_Sans:Regular',sans-serif] gap-[6px] items-center leading-[normal] not-italic relative shrink-0 text-[#4c4f59] text-[14px] w-[109px] whitespace-nowrap">
...
function SuccessToast() {
  return (
    <div className="absolute bg-[#fafffb] content-stretch drop-shadow-[0px_8px_12px_rgba(0,0,0,0.08)] flex gap-[12px] items-center left-[422px] px-[16px] py-[12px] rounded-[12px] top-[56px]" data-name="Success Toast">
