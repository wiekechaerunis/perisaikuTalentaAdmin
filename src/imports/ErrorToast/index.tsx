import svgPaths from "./svg-n7hod65rid";
...
export default function ErrorToast() {
  return (
    <div className="bg-[#fef2f2] content-stretch drop-shadow-[0px_8px_12px_rgba(0,0,0,0.08)] flex gap-[12px] items-center px-[16px] py-[12px] relative rounded-[12px] size-full" data-name="Error Toast">
      ...
      <Icon />
      <p className="[word-break:break-word] font-['DM_Sans:SemiBold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#ef4444] text-[14px] whitespace-nowrap">Lowongan Gagal dibuat</p>
      <Close />
    </div>
  );
}